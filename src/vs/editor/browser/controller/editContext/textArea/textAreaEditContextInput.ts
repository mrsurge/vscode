...
export class TextAreaInput extends Disposable {
	...
	private readonly _androidImeReseed: RunOnceScheduler;
	private readonly _androidImeFrame = this._register(new MutableDisposable<IDisposable>());
	...
	private _flushAndroidImeInput(): void {
	...
	private _reseedAndroidIme(): void {
	...
	private _cancelAndroidImeTransaction(): void {
		this._androidImeFrame.clear();
